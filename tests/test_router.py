...
@pytest.mark.parametrize(
    ("requested_model", "expected_provider", "expected_upstream_model"),
    [
        ("laya", LAYA_PROVIDER_NAME, ""),
        ("laya-auto", LAYA_PROVIDER_NAME, ""),
        ("laya-english", LAYA_PROVIDER_NAME, "english"),
        ("laya-multilingual", LAYA_PROVIDER_NAME, "multilingual"),
        ("laya-typed-decisions", LAYA_PROVIDER_NAME, "typed-decisions"),
        ("von", VON_PROVIDER_NAME, "von-1.1"),
        ("von-1.1.0", VON_PROVIDER_NAME, "von-1.1"),
    ],
)
...
@pytest.mark.parametrize(
    "requested_model",
    ["", "remote-url", "https://example.test", "english", "LAYA", "jev", "jev-latest"],
)
